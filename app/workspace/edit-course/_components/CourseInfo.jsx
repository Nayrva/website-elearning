...
import { Book, ChartNoAxesColumnIncreasing, Clock, Loader2Icon, PlayCircle, Settings } from 'lucide-react';
    ...
    <div className='md:flex gap-5 justify-between p-5 rounded-2xl shadow'>
        <div className='flex flex-col gap-3'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
                ...
                <div className='flex gap-5 items-center p-3 rounded-lg shadow'>
                    <ChartNoAxesColumnIncreasing className='text-red-500'/>
                    <section>
            ...
            {!viewCourse ? 
            <Button className={'max-w-4xl'} onClick={GenerateCourseContent} 
            disabled={loading}> 
        ...
        width={400}
        height={400}
        className='w-full mt-5 md:mt-0 object-cover aspect-auto h-[280px] rounded-2xl'
        />
    </div>
  )
}
